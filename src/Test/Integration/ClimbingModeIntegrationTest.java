...
//
    ...
    public void testaddCycling_InvalidCase() {
        ...
        ClimbingMode clm = new ClimbingMode(null, scan, null, null);
        clm.addCycling(1);
        assertEquals("Do you want to cycle to the point? [Y/N]"+System.lineSeparator()+
    ...
    public void testchooseClimbingPath() {
        ...
        assertEquals("Please enter the id of the climbing path that you would like to choose :"+System.lineSeparator() +
                "This is the climbing trail chosen:"+System.lineSeparator() +
    ...
    public void testchooseClimbingPath_NotExist() {
        ...
        cm.chooseClimbingPath();
        assertEquals("Please enter the id of the climbing path that you would like to choose :"+System.lineSeparator() +
                "The climbing path doesn't exist, please enter a valid climbing path id"+System.lineSeparator() +
                "This is the climbing trail chosen:"+System.lineSeparator() +
                "[1] (difficulty 1) Sheung Shui -> Tai Po", outputStreamCaptor.toString().trim());
    ...
    public void testchooseClimbingPath_WrongFormat() {
        ...
        cm.chooseClimbingPath();
        assertEquals("Please enter the id of the climbing path that you would like to choose :"+System.lineSeparator() +
                "The input should be an integer. Please try again:"+System.lineSeparator() +
                "This is the climbing trail chosen:"+System.lineSeparator() +
