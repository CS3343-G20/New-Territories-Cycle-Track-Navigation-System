...
public class VerticesTest {
    ...
    @Test
    public void listAllVertices_TestCase1()
    ...
    @Test
    public void listAllVertices_TestCase2()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase3()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase4()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase5()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase6()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase7()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    @Test
    public void listAllVertices_TestCase8()
            throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        Vertices vertices = Vertices.getInstance();
        vertices.listAllVertices();
    ...
    public void getRouteString_TestCase1() {
        ...
        route.add(2);
        route.add(0);
        vertices.getRouteString(route);
        assertEquals(true, outputContent.toString()
                .contains("Tsang Tai Uk -> Hong Kong Heritage Museum -> Sha Tin Che Kung Temple"));
    }

    @Test
    public void getRouteString_TestCase2() {
        Vertices vertices = Vertices.getInstance();
        ArrayList<Integer> route = new ArrayList<>();
        route.add(5);
        route.add(2);
        ...
        vertices.getRouteString(route);
        assertEquals(false,
                outputContent.toString().contains("Tsang Tai Uk -> Hong Kong Heritage Museum -> Lei Uk Tsuen"));
    }
    ...
    public void checkVertexIdValidity_TestCase2() throws ExInvalidIndex {
        Vertices vertices = Vertices.getInstance();
        ExInvalidIndex thrown = assertThrows(ExInvalidIndex.class, () -> vertices.checkVertexIdValidity(20));
