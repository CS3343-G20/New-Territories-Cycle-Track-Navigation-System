...
public class CyclingModeTest {
    ...
    public void setDeparture_case3()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubVertices implements VerticesManager {
            public void listAllVertices() {
            }
    ...
    public void setDestination_case6()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubVertices implements VerticesManager {
            public String getVertexNameByID(int id) {
                return null;
    ...
    public void setDestination_case7()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubVertices implements VerticesManager {
            public String getVertexNameByID(int id) {
                return null;
    ...
    public void addAttractions_case3()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubVertices implements VerticesManager {
            public void listAttractions() {
            }
    ...
    public void addAttractions_case4()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        String input = "N";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
    ...
    @Test // Wrong command
    public void addAttractions_case5()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubVertices implements VerticesManager {
            public void listAttractions() {
            }

            public int checkAttractionIdValidity(int id) {
                return id;
            }
            ...
            public int checkVertexIdValidity(int id) {
                return id;
            }
    ...
    public void routePlanning_case2()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubGraph implements GraphUtility {
            public void dijkstra(String priority, int s) {
            }
    ...
    public void routePlanning_case3()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        class stubGraph implements GraphUtility {
            public void dijkstra(String priority, int s) {
            }
    ...
    public void membeExecute_case1()
        ...
        stubBookmark mark = new stubBookmark();
        CyclingMode mode = new CyclingMode(new stubGraph(), new stubVertices(), new Scanner(System.in), mark);
